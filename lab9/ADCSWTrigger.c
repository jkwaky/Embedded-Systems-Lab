...
//int32_t ADCTemp[65] = {400, 392, 385, 378, 370, 363, 356, 348, 342, 335, 327, 320, 313, 306, 299, 293, 286, 279, 272, 266, 259, 252, 246, 239, 233, 227, 220, 214, 208, 201, 195, 189, 183, 177, 170, 164, 158, 152, 146, 140, 134, 128, 123, 117, 111, 105, 99, 94, 88, 82, 77, 71, 66, 60, 54, 49, 43, 37, 32, 27, 22, 16, 11, 5, 0};
...
uint8_t indexholder = 0;
uint32_t ADCAverage = 0;
void ADC0Seq3_Handler(void){
  ADC0_ISC_R = 0x08;          // acknowledge ADC sequence 3 completion
	ADCAverage = ADCAverage- ADCvalue[indexholder];
  ADCvalue[indexholder] = ADC0_SSFIFO3_R;  // 12-bit result
	ADCAverage = ADCAverage+ ADCvalue[indexholder];
	indexholder++;
